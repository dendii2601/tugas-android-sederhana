<?php
include("../config.php");
$konsumens = mysqli_query($conn,"SELECT * FROM konsumens ");
$rows = array();
while($row = mysqli_fetch_assoc($konsumens)){
    $rows[] = $row;
}
        ...
        <div class="container-fluid">
          ...
          <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                <a class="btn btn-danger" href="../beckend/admin/delete_konsumen.php?id=<?= $r['id'];?>">Delete</a>
                <a class="btn btn-primary" href="../update/update_konsumen.php?id=<?= $r['id'];?>">Edit</a>
                </td>
            </tr>
            <?php $no++;
            endforeach ; ?>
