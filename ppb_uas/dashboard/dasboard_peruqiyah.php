      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Peruqiyah</h1>
          </div>
          <a class="btn btn-sm btn-primary mb-4" href="../insert/daftar_peruqiyah.php" id="navbarbutton" role="button" aria-haspopup="true" aria-expanded="false">
          Insert Peruqiyah
          </a>
          ...
          <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                <a class="btn btn-danger" href="../beckend/admin/delete_peruqiyah.php?id=<?= $r['id'];?>">Delete</a>
                <a class="btn btn-primary" href="../update/update_peruqiyah.php?id=<?= $r['id'];?>">Edit</a>
                </td>
            </tr>
            <?php $no++;
            endforeach ; ?>
