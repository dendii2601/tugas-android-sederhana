<?php
include("../config.php");
$admints = mysqli_query($conn,"SELECT * FROM user ");
$rows = array();
while($row = mysqli_fetch_assoc($admints)){
    $rows[] = $row;
}
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Login Admin</h1>
          </div>
          ...
          <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                <a class="btn btn-danger" href="../beckend/admin/delete_admin.php?id=<?= $r['id'];?>">Delete</a>
                <a class="btn btn-primary" href="../update/update_user.php?id=<?= $r['id'];?>">Edit</a>
